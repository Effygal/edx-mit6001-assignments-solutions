...
def getWordScore(word, n):
    ...
    result = 0
    for leter in word:
        result += SCRABBLE_LETTER_VALUES[leter]
...
def isValidWord(word, hand, wordList):
    ...
    for leter in word:
        try:
            ...
            if hand_copy.get(leter, 0) < 0: 
                flag = False
                break
        
    return flag and word in wordList
    ...
    while sum(hand.values()) != 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                score_temp = getWordScore(word, n)
                score += score_temp
                print('"',word,'"' + "earned ", score_temp, "points. Total:", score, "points")
                print("")
                # Update the hand 
